...
export default function CreateDashboardSheet({
  ...
  const handleCreateDashboard = useCallback(async () => {
    ...
    try {
      ...
      await storage.saveDashboard(newDashboard);
  ...
  }, [formData, storage, onOpenChange, resetForm, onDashboardCreated]);
    ...
    <Sheet open={isOpen} onOpenChange={handleOpenChange}>
      <SheetContent className="sm:max-w-[540px] overflow-y-auto">
        ...
        <div className="space-y-6 p-6">
          ...
          {/* Description */}
          <div className="space-y-2">
            <Label htmlFor="dashboard-description" className="flex items-center gap-2">
