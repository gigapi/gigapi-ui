...
export default function App() {
    ...
    return (
      <ThemeProvider defaultTheme="dark" storageKey="gigapi-theme">
        <div className="h-screen flex flex-col items-center justify-center text-muted-foreground">
          <img src={Logo} alt="GigAPI Logo" className="h-10 w-10 mb-4 animate-pulse" />
          Loading application...
        </div>
        <Toaster />
      </ThemeProvider>
  ...
  const isCriticalError = error && !error.toLowerCase().includes("no databases found");
    ...
    return (
      <ThemeProvider defaultTheme="dark" storageKey="gigapi-theme">
        <div className="h-screen flex flex-col items-center justify-center p-4 text-center">
          ...
          <h1 className="text-2xl font-semibold mb-3 text-destructive">Application Initialization Error</h1>
